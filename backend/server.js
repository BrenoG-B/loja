...
app.post("/produto",(req,res)=>{
    ...
    const {nome,descricao} = req.body //variavel entre chaves (destruct) permite conexão com servidor e frontend
...
// ROTA PARA CONSULTAS PERSONALIZADAS
app.get("/produto/search", (req, res) => {
    const {pesquisa} = req.query; //(destruct)
    if(!pesquisa){
